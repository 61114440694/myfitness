      ...
      <Container>
            ...
            <Card className={classes.root}>
              <CardActionArea style={{ backgroundColor: "#bdc3c7" }}>
                <CardContent>
                  ...
                  <Typography variant="body2" component="p">
                    สามารถใช้อุปกรณ์เเละสถานที่ออกกำลังกายได้อย่างเต็มที่
                    ลดทันที่ 100
                  </Typography>
                </CardContent>
              </CardActionArea>
            ...
            <Card className={classes.root}>
              <CardActionArea style={{ backgroundColor: "#bdc3c7" }}>
                <CardContent>
                  ...
                  <Typography variant="body2" component="p">
                    สามารถใช้อุปกรณ์เเละสถานที่ออกกำลังกายได้อย่างเต็มที่
                    เเละมีเทรนเนอร์ค่อยให้บริการตลอดเวลาการฝึก
                  </Typography>
                </CardContent>
              </CardActionArea>
              <CardActions style={{ backgroundColor: "#1e272e" }}>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={3}>
            ...
            <Typography variant="body2" component="p">
              หากคุณมีคำถามเกี่ยวกับเรา ต้องการทำงานร่วมกัน
              หรือมีอยากส่วนร่วมและสร้างโอกาสใหม่ทางธุรกิจ
          ...
          <Grid item xs={12} md={3}>
            <Card className={classes.root} color="#2f3640">
              <CardActionArea
                style={{ backgroundImage: "../home/img/fitness.jpg" }}
              >
                <CardContent>
                  <CardMedia
                    component="img"
            ...
            <CardActionArea>
              <CardContent>
                ...
                <Typography variant="body1" component="p">
                  ...
                  เราได้เห็นการเปลี่ยนแปลงมากมายและเราพัฒนามาไกลมาก
                  แต่เป้าของเรายังคงชัดเจน
                  เราคือผู้นำด้านการออกกำลังกายที่จะสร้างแรงบันดาลใจให้ทุกคนก้าวต่อไปข้างหน้า
                  ด้วยสมาชิกกว่า 500 คนในม.อุบล
                  เรามองหาวิธีใหม่ในการสนับสนุนและสร้างแรงบันดาลใจ
        ...
        <Grid container  spacing={3} >
          <Grid item xs="12" xs="5" style={{marginLeft:"40"}}>
        ...
        image="https://s3.amazonaws.com/findit-gallery/a18c5d0c-659a-4306-b07d-89f93a9ca7ff/749b6230-0fe7-4f81-9f93-88c61d0236b3_a18c5d0c-659a-4306-b07d-89f93a9ca7ff.jpg"
        title="Contemplative Reptile"
      />
          </Grid>
          <Grid item xs="12" xs="3"></Grid>
          <form onSubmit={senbmi}>
            <div>
              <h2>BMI</h2>
              <TextField
                id=""
        ...
        alt="Contemplative Reptile"
        height="300"
        image="https://img.kapook.com/u/2020/wittawat_ch/may/1_7.jpg"
        title="Contemplative Reptile"
      />
          </Grid>
        </Grid>
